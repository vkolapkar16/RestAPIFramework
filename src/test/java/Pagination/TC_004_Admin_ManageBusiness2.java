...
public class TC_004_Admin_ManageBusiness2 extends BaseClass_Admin
{
	FrameworkConfig cfg;
	   @BeforeClass
		public void setup()
	   ...
	   @Test
		public void getAllCompanies() throws IOException
		{
		  ...
		  int Upperlimit = 99;
			...
			Assert.assertEquals(Upperlimit, totalEntity);
		}
