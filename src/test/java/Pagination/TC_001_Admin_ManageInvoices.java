...
public class TC_001_Admin_ManageInvoices extends BaseClass_Admin
{
	FrameworkConfig cfg;
	   @BeforeClass
		public void setup()
	   ...
	   @Test
		public void getAllInvoices() throws IOException
		{
		  ...
		  RequestSpecification httpRequest = RestAssured.given();
			...
			System.out.println("Total Invoices Count = "+resultCount);
			...
			Assert.assertEquals(resultCount, totalInvoices);
		}
