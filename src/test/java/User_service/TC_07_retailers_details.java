...
public class TC_07_retailers_details extends BaseClass_Admin
{
	public String ENDPOINT="user/retailers/dashboard";
	FrameworkConfig cfg;
    @BeforeClass
	public void setup()
	{
    ...
    @Test
	public void getRetailersDetails()
	{
		...
		RequestSpecification httpRequest = RestAssured.given();
   		...
   		String state = jsonPathEvaluator.get("states[1]");
   		int statecount = jsonPathEvaluator.get("total_count");
   		...
   		System.out.println("State Count :" + statecount);
   		 ...
   		 sa.assertNotNull(state);
   	 	 sa.assertNotNull(statecount);
   		 sa.assertAll();
	 }
